...
fn main() -> Result<(), eframe::Error> {
    let options = eframe::NativeOptions {
        viewport: egui::ViewportBuilder::default()
            .with_icon(load_icon())
            .with_inner_size(Vec2::new(417.0, 481.0))
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ui.vertical_centered(|ui| {
                    ...
                    .clicked()
                {
                    ...
                    self.gameboard
                        .populate_mines(10)
                        .expect("Failed to populate mines");
                    self.gameboard
                        .populate_numerals()
                        .expect("Failed to populate numerals");
                }
